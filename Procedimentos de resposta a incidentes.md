...
- Sanitizar dados sigilosos ou que não sejam essenciais identificação do incidente tais como dados pessoais (PII), IP's/redes e nomes de máquinas dp destino/alvo
- Evitar mensagem de caráter jurídico, acu