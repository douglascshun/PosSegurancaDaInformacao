...
O Ant assina usando sua chave privada(pra posteriormente a pessoa abrir usando sua chave publica), depois você pega a chave publica da pessoa e criptografa (pra quando a mensagem navegar na internet ninguém ter acesso) então você envia, nisso a pessoa usa a chave privada dela pra abrir a mensagem, e depois ela usa a sua chave publica pra abrir a mensagem e obter acesso ao dado original