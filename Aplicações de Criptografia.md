...
O Antonio assina usando sua chave privada (onde posteriormente a Paula vai  abrir usando a chave publica de Antonio), Antonio usa a chave publica da Paula e criptografa a mensagem novamente (para quando a mensagem navegar na internet ninguém ter acesso) então ele envia para Paula, dado o momento que P` a chave privada dela pra abrir a mensagem, e depois ela usa a sua chave publica pra abrir a mensagem e obter acesso ao dado original