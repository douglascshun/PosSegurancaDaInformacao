...
Se quiser implementar segurança nesse processo, é possível usar a chave pública da pessoa que você está enviando a mensagem e criptografar a sua mensagem quando for enviar, nisso só a pessoa que você enviou a mensagem pode ter acesso a isso
