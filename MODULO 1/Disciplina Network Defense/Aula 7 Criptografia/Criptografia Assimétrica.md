...
Dada a circunstancias, veio como solução para contornar esse risco o uso de Chaves Públicas e Chaves Privadas. Esses par de chaves são características únicas da criptografia assimétrica, o receptor disponibiliza no canal comprometido, ou seja, onde todos podem ter acesso, uma chave 