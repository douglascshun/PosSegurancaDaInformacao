...
Podemos exemplificar isso como no exemplo anterior, onde em ma sala de uma empresa tem a Clara, Ana e o Bob. Clara que falar algo confidencial para o Bob sem que Ana saiba o que é, então Bob deixa cofrinho com um cadeado, todos tem acesso 