...
Isso se exemplifica da seguinte forma, em um cenário onde há três indivíduos em uma sala a Clara, Ana e Bob. Clara quer falar a quantidade de clientes ativos na empresa para o Bob, sem que Ana tenha acesso a informação confidencial, então Ana e Bob cria uma equação simples para mascarar o número. Supondo que o número original seja 123.123 a Ana multiplica esse número por 2, o que resulta em 246.246. 