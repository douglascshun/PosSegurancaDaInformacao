...
Partindo da situação de que agora o usuário vá comprar em uma loja online, e esse item é caro, como por exemplo um carro de luxo, é bem possível que a loja online solicite uma assinatura digital ao usuário concordar com os termos do contrato de compra, essa assinatura é um dado que a chave privada gera, esse dado é encaminhado para o lojista que verifica a compatibilidade com o resultado do calculo de resultados comparando com 