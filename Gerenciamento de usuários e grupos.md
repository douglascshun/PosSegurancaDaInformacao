...
Para adicionar usuários ao grupo o processo é uma logica simples, comando `usermod`, que seria o equivalente a "modificar usuário", seguido de `-aG` onde podemos pensar em algo do tipo "Adicionar o "